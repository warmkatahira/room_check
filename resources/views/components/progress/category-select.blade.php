...
<div class="grid grid-cols-12 gap-2 mb-5">
    <a href="{{ route('progress.customer') }}" class="category_select col-span-4 xl:col-span-1 text-center py-2 px-5 bg-theme-sub"><i class="las la-user la-lg mr-1"></i>荷主</a>
    <a href="{{ route('progress.base') }}" class="category_select col-span-4 xl:col-span-1 text-center py-2 px-5 bg-theme-sub"><i class="las la-warehouse la-lg mr-1"></i>拠点</a>
    <a href="{{ route('progress.tag') }}" class="category_select col-span-4 xl:col-span-1 text-center py-2 px-5 bg-theme-sub"><i class="las la-tag la-lg mr-1"></i>タグ</a>
    @if($bases)
